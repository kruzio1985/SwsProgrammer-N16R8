...
Prebuilt image: `firmware/sws_programmer_esp32s3_n16r8_v1.2.bin`.
...
```powershell
esptool.py --chip esp32s3 --port COMx --baud 921600 write_flash -z 0x10000 firmware\sws_programmer_esp32s3_n16r8_v1.2.bin
```
...
Gotowy obraz: `firmware/sws_programmer_esp32s3_n16r8_v1.2.bin`.
